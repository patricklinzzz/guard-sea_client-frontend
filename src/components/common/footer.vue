    ...
    <div id="container">
      <div id="footer_img">
        ...
        <div id="social_media_icon">
          ...
          <a href=""><img src="../../assets/images/footer/email.svg" alt="" /></a>
        </div>
      </div>
      <div>
        本網站為緯育TibaMe前端工程師班學員專題作品，本平台僅供學習、展示之用。若有侵權疑慮,
        您可以私訊 [
        <a href="https://www.facebook.com/TibaMe" target="_blank">緯育</a>
        ] ,後續會由專人協助處理。
      </div>
      <div>&copy; 2025 GuardSea. All rights reserved.</div>
    </div>
  </footer>
</template>
